    ...
    <div className="min-h-screen bg-yellow-50 p-4 font-sans pt-20">
      ...
      <nav className="bg-white shadow-md p-4 flex justify-between items-center fixed top-0 left-0 right-0 z-50">
        ...
        <ul className="flex gap-6 text-sm text-gray-700 font-medium">
          <li>
            <a href="#cardapio" className="hover:text-orange-500">
              Cardápio
            </a>
          </li>
          <li>
      ...
      <section className="my-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
          {products.map((item, index) => (
            <motion.div
              key={item.name}
              className="bg-white rounded-xl shadow-md flex flex-col justify-between h-[420px] transform transition-transform duration-300 hover:scale-105 hover:shadow-lg p-4"
            >
              {/* Conteúdo do card */}
              <div className="flex-1 flex flex-col">
                ...
                <p className="text-gray-600 text-sm my-2 flex-1">
                  {item.description}
                </p>
              ...
              <button className="bg-orange-500 hover:bg-orange-600 text-white rounded-xl py-2 mt-4 flex items-center justify-center gap-2 w-full">
